...
def _padding(text, mode=SM4_ENCRYPT):
    ...
    加密填充和解密去填充
    """
    _str_or_bytes =  (string_types + (binary_type,))
...
#plain_text = '我冷眼向过去稍稍回顾，只见它曲折灌溉的悲喜，都消失在一片亘古的荒漠，这才知道我的全部努力，不过完成了普通的生活。'
#key = 'hello, world!'
#test='HZ94LS4GDbEhtGbyR1pGu+xYrHdymuo/ao73W3sh0a8xkqFXrxLUI7zgP/7Yx6LcVmIarVdzV8IBWj+pZcPRrcraQCZRrHuL+8S2i9RRSxjExxMLWOAMXdVVg1KAE69zZDGmpZJe8d/DowFSpAA4dX4J3Kmf1+cfuXOrapJAElWY+RvmuwvJT4t+WHjwtVKofi2UPOvZ03um36KLws8HcQm1LzLAq4gP+Pw32eUtukw='
#print(decrypt_cbc(test, key))

# print('plaintext', plaintext)
# print(encrypt_cbc(plaintext, key))
